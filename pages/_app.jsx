...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Adithi</title>
        <link rel="shortcut icon" href="https://cdn.discordapp.com/attachments/1070755738563125390/1081995828606013460/IMG_3081.gif" type="image/x-icon" ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">Adithi</p>
